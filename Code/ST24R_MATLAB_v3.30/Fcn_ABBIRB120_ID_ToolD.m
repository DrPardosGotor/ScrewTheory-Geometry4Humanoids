%% "Fcn_ABBIRB120_ID_ToolD" Inverse Kinematics IRB120 ToolDown.
%
% Solves rhe INVERSE DYNAMICS for a desired  position, velocity 
% acceleration of the jointsmof the ABB IRB120 Robot.
%
...
% The tipycal example is PoAcc = [0 0 -9.81] for gravity on -Z;
% The outputs:

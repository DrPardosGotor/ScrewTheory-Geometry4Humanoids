%% "NPotentialSym" POTENTIAL matrix N(t) for an open chain manipulator.
% the computation is SYMBOLIC and then the position t are valued.
% Use in SE(3).
%
...
%% Nt = NPotentialSym(TwMag,LiMas,PoAcc)
%
function Nt = NPotentialSym(TwMag,LiMas,PoAcc)
%
    n = size(TwMag,2);

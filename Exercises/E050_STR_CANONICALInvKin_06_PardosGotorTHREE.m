%% Screw Theory - CANONICAL subproblem - Exercise Pardos-Gotor THREE (PG3).
%
% Calculate IK for a single movement using PardosGotorThree function.
...
% are defined by: Axis = Axis1, Point = p1, JointType = 'tra';
...
%
%% E050_STR_CANONICALInvKin_06_PardosGotorTHREE
%
clear
clc
%
...
Mag = rand; % for testing various magnitudes
%
Axis1 = [1 0 0]';
p1 = [0 0 0]';
JointType1 = 'tra';

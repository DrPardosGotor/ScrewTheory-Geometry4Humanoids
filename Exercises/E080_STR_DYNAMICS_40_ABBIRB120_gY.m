...
% with th Jst funtion for M(t) and symbolic solution for N(t).
%
% M(t) Inertia matrix by the use of Jst LINK Jacobian.
...
%
% N(t) Potential Matrix by the use of Aij Adjoint transformation.
NtST24RSym = NPotentialSym(TwMag,LiMas,PoAcc);
%
